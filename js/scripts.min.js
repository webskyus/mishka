...
$(function(){var o;$(document).ready(function(){svg4everybody({})}),$("a.trigger").on("click",(o=0,function(){0===o?(o=1,$(".main-nav__item").css("visibility","visible"),$(".main-nav__logo-images").css("left","0"),$(".main-nav__item").css("transform","translate(0)")):1===o&&(o=0,$(".main-nav__item").css("transform","translate(-150%)"),$(".main-nav__logo-images").css("left","150%"))})),$(window).resize(function(){560<$(document).width()&&($(".main-nav__item").css("transform","translate(0)"),$(".main-nav__logo-images").css("left","0%"))}),$(".feedback-slider").slick({slidesToShow:1,slidesToScroll:1,fade:!0,arrows:!0}),$(document).ready(function(){$(".form-radiobox__label--checkbox").on("click",function(){$(".form-radiobox__btn--checkbox").removeClass("form-radiobox__btn--active"),$(this).find(".form-radiobox__btn--checkbox").toggleClass("form-radiobox__btn--active")})}),$(document).ready(function(){$(".form-radiobox__label--radiobtn").on("click",function(){$(".form-radiobox__btn--radiobtn").removeClass("form-radiobox__btn--active"),$(this).find(".form-radiobox__btn--radiobtn").toggleClass("form-radiobox__btn--active")})}),$(document).ready(function(){$("a,img").on("dragstart",function(o){o.preventDefault()})}),$(document).ready(function(){$(".main-nav__link--search").click(function(o){o.preventDefault(),$(".search-popup").css("transition-delay","0s"),$(".search-popup").css("transform","scale(1)"),$(".search-form").css("opacity","1"),$(".search-form").css("transform","translateY(0)")}),$(".search-form__close").click(function(){$(".search-popup").css("transition-delay","0.5s"),$(".search-popup").css("transform","scale(0)"),$(".search-form").css("transform","translateY(-10%)"),$(".search-form").css("opacity","0")})}),$(document).ready(function(){$(".video-box__link").click(function(o){o.preventDefault(),$(".video-popup").css("transition-delay","0s"),$(".video-popup").css("transform","scale(1)"),$(".video-container").css("opacity","1"),$(".video-container").css("transform","translateY(0)")}),$(".video-container__close-btn").click(function(){$(".video-popup").css("transition-delay","0.5s"),$(".video-popup").css("transform","scale(0)"),$(".video-container").css("transform","translateY(-10%)"),$(".video-container").css("opacity","0")})}),$(document).ready(function(){$(".catalog-products__icon-basket").click(function(o){o.preventDefault(),$(".basket-popup").css("transition-delay","0s"),$(".basket-popup").css("transform","scale(1)"),$(".basket-form").css("opacity","1"),$(".basket-form").css("transform","translateY(0)")}),$(".basket-form__close").click(function(){$(".basket-popup").css("transition-delay","0.5s"),$(".basket-popup").css("transform","scale(0)"),$(".basket-form").css("transform","translateY(-10%)"),$(".basket-form").css("opacity","0")})}),$(document).ready(function(){$(".basket-form__size").on("click",function(){$(".basket-form__size--active").removeClass("basket-form__size--active"),$(this).addClass("basket-form__size--active")})}),$(window).scroll(function(o){$(this).scrollTop()>$(this).height()?($(".to-top").addClass("visible"),$(".to-top").removeClass("hidden")):($(".to-top").removeClass("visible"),$(".to-top").addClass("hidden")),$(".to-top").click(function(o){$("html, body").stop().animate({scrollTop:0},"slow")})}),$(document).ready(function(){var o;$(".trigger").click((o=1,function(){1===o?(o=2,$(".trigger__line--top").css("width","60%"),$(".trigger__line--middle").css("width","80%")):2===o&&(o=1,$(".trigger__line--top").css("width","100%"),$(".trigger__line--middle").css("width","100%"))}))}),$(".preloader").delay(1500).fadeOut("slow")});